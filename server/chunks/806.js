...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ NinthDE_NinthDE)
});

// EXTERNAL MODULE: external "react"
var external_react_ = __webpack_require__(6689);
var external_react_default = /*#__PURE__*/__webpack_require__.n(external_react_);
;// CONCATENATED MODULE: ./src/components/DynamicEffectBg/components/CanvasMethods/NinthCM.js
var Bird;
function draw() {
  ...
  Bird.obj = Bird.def(function () {
    this.vtr = new Bird.Vtr(), this.accel, this.width = 600, this.height = 600, this.depth = 300, this.ept, this.area = 200, this.msp = 4, this.mfrc = 0.1, this.coll = false;
  ...
  Bird.Tri = Bird.def(function (p1, p2, p3) {
  ...
  Bird.Vtr = Bird.def(function (x, y, z) {
    this.x = x || 0;
    this.y = y || 0;
    this.z = z || 0;
    this.fl = 1000;
...
;// CONCATENATED MODULE: ./src/components/DynamicEffectBg/components/NinthDE/NinthDE.tsx
 // import './style.css'
...
class NinthDE extends (external_react_default()).Component {
  constructor(props) {
    super(props);
  }
...
/* harmony default export */ const NinthDE_NinthDE = (NinthDE);
