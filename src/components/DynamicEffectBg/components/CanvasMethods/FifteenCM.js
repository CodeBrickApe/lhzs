...
var canvas, ctx, canvasWidth, canvasHeight, shapes, sizeVariation, iteration, animationDirection, sizeVariationRange, baseRotation, baseSize, c1, c1S, c2, c2S, c3, c3S, requestIDList = [];


export const RenderFifteenCanvas = () => {
...
export const ResetFifteenCanvas = () => {
